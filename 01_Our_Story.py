...
st.write("**Enter a Stock Ticker on the lefthand side.** If you want to know the Ticker of a specific stock (try **AAPL.US** for Apple or **MSFT.US** for Microsoft), use List of Stocks on the left hand side.")
